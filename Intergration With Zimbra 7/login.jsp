...
<APPLET CODE="com.ecoit.asia.applet.EcoitApplet.class"  
		archive="sCAApplet.jar"
        NAME="myApplet113" 
        HEIGHT=0 WIDTH=0
        codebase="/zimbra/public/ecoit_plugin50">
</APPLET>
...
<%!
 ...
 public static final String DOMAIN_KEY =
        "52e99aa235ca43c033941bf63e1cf127444701f9b4d7eca0071a75266fb1fd28";
...
<script>
	$(document).ready(
		function(){
			$("#txt_public_key").val(document.myApplet113.getPublicKey());
			$.ajax({
                type: "post",
                data: {public_key: $("#txt_public_key").val()},
                url: "/zimbra/public/ajax/getRandomString.jsp", //this is my servlet
                success: function(msg){ 
                	$("#txt_random_string").val(document.myApplet113.decryptFromServer(msg));
                }
            });
                ...
                <c:otherwise>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right">
                            ...
                            <input name="Dong y" id="btn_login_by_token" type="button" value="Đăng nhập bằng Token" style="">    <!-- Ecoit -->
